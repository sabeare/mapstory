var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description: 'Tijdens veel Walk&Talk interviews kwam naar voren dat er in het Soesterkwartier regelmatig meerdere generaties na elkaar in hetzelfde huis wonen. Dat zegt voor mij iets over de verbondenheid die zij voelen met die plek. Al haar hele leven woont mevrouw Verheuvel, ruim negentig jaar oud, in dit huisje. Ze is de vierde generatie die in dit huis woont: ook haar ouders, grootouders en overgrootmoeder hebben hier gewoond.             Ik hoorde dit verhaal tijdens de wandelingen door de buurt. Later sprak ik hierover de zus van mevrouw Verheuvel, tijdens mijn bezoek aan een dagbestedingsgroep van beginnende dementerenden. Zij vertelde mij dat haar overgrootmoeder weduwe werd en met haar kinderen dit huisje mocht betrekken in ruil voor het onderhoud van de naast gelegen Joodse begraafplaats. Door deze anekdote als slow datavisualisatie toe te voegen aan de conversation piece heb ik dit verhaal zichtbaar gemaakt en kan ik dit delen met andere <em>wijkmakers</em> in het Soesterkwartier.                     ',
            location: {
        ...
        },
        {
            ...
            image: '',
            description: 'De <a href="#methode"> slow datavisualisaties </a>  hierboven laat zien naar welke scholen de kinderen uit het Soesterkwartier gaan. Het blijkt dat de meerderheid van de kinderen buiten de wijk naar school gaat (groen). Is dat erg? In veel van de Walk&Talk interviews die ik maakte kwam deze scholenproblematiek als onderwerp ter sprake.            Sommige vertelden over de afwegingen die ze gemaakt hadden over wel of niet in de buurt naar school gaan. Voor meerdere was het grove taalgebruik van kinderen op de buurtscholen een reden om naar andere scholen buiten de buurt te gaan kijken.            Een van de wandelaars, die ontevreden is over de huidige buurtscholen in de wijk, stelde voor om alle scholen te sluiten en één nieuwe school op een nieuwe locatie te ontwikkelen,  inclusief nieuw docenten- en directieteam.            Ook vertelde iemand over de komst van een internationale school in één van de scholen vanwege de gunstige ligging bij het treinstation en omdat de internationale scholen in de omliggende grote steden allemaal vol zitten. Volgens haar was dit positief omdat de internationale school een samenwerking met alle scholen aangaat en zo het Engels onderwijs op alle buurtscholen kan verbeteren.             Het is nog onduidelijk wat deze oplossingen teweeg kunnen brengen. Ik maakte een dataset over welke scholen door de lagere schoolleerlingen uit de wijk Soesterkwartier bezocht worden. Dit deed ik met gegevens die ik verkreeg via het basisscholen overzicht van allecijfers.nl (allecijfers.nl/basisscholen-overzicht/amersfoort/). Ik gebruikte deze data om ieder kind te eren met een geborduurd knoopje op het tafelkleed. Tijdens het borduren reflecteerde ik op de informatie en quotes die ik had gekregen tijdens de wandelinterviews.              De scholen kampen met de gevolgen van sociaaleconomische segregatie. De kinderen van vooral hoger opgeleide ouders gaan buiten de wijk naar school, waardoor de scholen in de wijk in een alsmaar grotere vicieuze cirkel terecht zijn gekomen. Er is meer gelaagde informatie nodig, dan alleen cijfers van het aantal kinderen om oplossingen te vinden waardoor alle kinderen in deze wijk dezelfde schoolkansen hebben.                       ',
            location: {
                center: [5.37024, 52.16024],
                zoom: 16.47,
                pitch: 55.50,
        ...
        },
        {
            ...
            alignment: 'right',
            hidden: false,
            title: 'Methode | Verkennen | Tracks ',
            image: '',
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'Methode | Verbeelden | Borduren',
            image: '',
