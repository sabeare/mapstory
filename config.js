    ...
    chapters: [
        {
            ...
            iframe: '',
            description: 'Deze publicatie in de vorm van een storymap komt het beste tot zijn recht op een computerscherm.  Het is gemaakt voor “wijkmakers”, iedereen die zich inzet voor het gelijkwaardiger maken en verbeteren van de leefomgeving op een creatieve,  verbindende en tastbare manier. <br><br>            Ik maakte deze publicatie over participatief en ontwerpend wijkonderzoek in het kader van mijn master Design Research aan de Willem de Kooning Academy in Rotterdam. <br><br>            De opbouw is als volgt: het begint met de conclusie om een algeheel idee te krijgen. Vervolgens geef ik een beknopte uitleg over de ontwikkelde methode; slow datavisualisatie. Daarna toon ik aan de hand van de conversation piece, het geborduurde tafelkleed, de iteraties en wat dat heeft opgeleverd.<br><br>  Als laatste ga ik dieper in op de rol van borduren aan de hand van het community borduurproject “sterke vrouwen”. Wat ik opzette in de wijk het Soesterkwartier.<br><br>     Deze storymap is al scrollend naar benden lezen. Zo ontvouwt het hele onderzoek zich. Een andere optie is om via het tabblad: inhoud, gericht naar de gewenste hoofdstukken te hoppen. In de andere tabbladen onderin is aanvullende informatie te vinden, zoals een samenvatting, het colofon, de bibliografie en het lexicon. Deze tabbladen zijn ieder moment te raadplegen. <br><br>  Baukje Rienks',
            location: {
