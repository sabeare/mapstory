var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            imageDescription:'Netwerkschema van walk&talkdeelnemers',
            description: 'Ik merkte dat het merendeel van de <em>wijkmakers</em> die ik sprak, vaker te horen zijn in de wijk, via de media en de gemeente. Maar ik sprak ook <em>wijkmakers</em> die organisaties vertegenwoordigen met meer onzichtbare doelgroepen, zoals bijvoorbeeld kinderen (Kinderwijkraad) en ouderen met beginnende dementie (King Arthur Groep). Via de walk&talkinterviews kon ik mijn eigen netwerk in de wijk uitbreiden, wat mij verder hielp om contact te krijgen met de meer verborgen doelgroepen.                   ',
            location: {
