var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            description: 'Je kunt dit verhaal op twee manieren lezen. Ten eerste scrollend door deze storymap.  Zo ontvouwt het hele onderzoek en kom je overal langs. De achtergrond kaart geeft extra context over het gebied. De tekstvakken links gaan over de opbouw en achtergrond van de methode. De tekstvakken rechts gaan over de verhalen en resultaten van de case namelijk het Soesterkwartier in Amersfoort.              Een andere manier is om via de buttons op het tafelkleed te navigeren. Zo volg je je eigen pad door de verhalen uit het Soesterkwartier en de achtergrond van de methode. De blauwe buttons gaan specifiek over het Soesterkwartier. De oranje buttons over de methode.',
            location: {
                center: [5.36207, 52.15940],
                zoom: 14.00,
                pitch: 13.00,
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'wat is slow design research',
            image: 'images/autotuin.png',
