var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description: 'De tweede stap is het verbeelden van de vergaarde informatie en subjectieve data in mappings en slow datavisualisaties. Door het verbeelden bewust te vertragen door te borduren, ontstaat er meer ruimte voor reflectie. Dit is van belang om nieuwe inzichten over de beleving van de wijk te verkrijgen. Het borduren deed ik zowel alleen als in groepsverband, in een community project met verschillende participanten, <em>wijkmakers</em> zoals bewoners, stedenbouwers of vrouwen met beginnende dementie. Dit project leidde tot bijzondere ontmoetingen, gesprekken en verhalen. ',
            location: {
                center: [5.36207, 52.15940],
                zoom: 14.00,
                pitch: 13.00,
        ...
        },
        {
            ...
            description: 'Het redden van een monumentale boom was mijn eerste wijkactie, drie jaar geleden. We maakten met de buurt een gehaakte sjaal voor de zieke kastanje aan de IJsselstraat in Amersfoort. Met een succesvolle afloop! De monumentale boom mocht blijven staan. Het doet me goed dat mensen genieten van <em>onze</em> kastanje. Voor mij was deze actie ook het startsein om het Soesterkwartier als gebied te kiezen om mijn methode voor participatief wijkonderzoek te ontwikkelen. <br><br>               Deze jaren 30-wijk ligt in Amersfoort en is mijn eigen leefomgeving. De nabijheid van een wijk maakt het eenvoudiger om je er langdurig aan te verbinden, maar het is geen voorwaarde om participatief wijkonderzoek te kunnen doen. <br><br>           In deze wijk komen veel maatschappelijke issues samen. Denk aan gentrificatie en nieuwbouw die leidt tot een toenemende druk op de voorzieningen en het groen. Een gerelateerde ontwikkeling is een toename in van het wij-zij denken, de polarisatie binnen de wijk. <br><br>             Deze voormalige volksbuurt ligt <em>boven</em> het treinstation van Amersfoort en is zo’n honderd jaar oud. Vanwege het spoor heeft het Soesterkwartier een wat geïsoleerde ligging. Ondanks dat de wijk dicht bij het centrum ligt, groeten de mensen elkaar hier op straat, alsof het een dorp is. De wijk bestaat uit meerdere buurten. De belangrijkste zijn de: Bloemen-, Bomen- en Rivierenbuurt.                               ',
            location: {
        ...
        },
        {
            ...
            description: 'Om verbinding aan te gaan met de wijk en haar <em>wijkmakers</em> ontwierp ik vervolgens de walk&talk-interview-methode. Ik wilde een netwerk van wijkmakers van het Soesterkwartier in kaart brengen. Daarom besloot ik voor deze iteratie geen gender onderscheid te maken. <br><br>            Ik benaderde drie <em>wijkmakers</em> om mee te starten. Met elk van hen maakte ik een wandeling. De walk&talk methode waren bewust gesprekken tussen twee personen, waarbij ik erop gericht was om met volle aandacht naar de wijkmaker te luisteren. De deelnemer bepaalde al wandelend de route en we hadden vaak hele open en persoonlijke gesprekken vanuit de vraag “Hoe gaat het met Soesterkwartier?” Naderhand adviseerden de wijkmakers mij over nieuwe participanten om te benaderen. Ik kreeg op deze manier een goed inzicht in het <a href="#net">netwerk</a> van wijkmakers en hoe deze mensen met elkaar verbonden zijn. <br><br>            De meeste wandelingen duurden langer dan anderhalf uur. Sommige waren begrensd op een uur, maar dan had de deelnemer vooraf al aangegeven beperkt de tijd te hebben. Ik merkte dat de deelnemers, doordat zij zelf de tijd bepaalden vaak ruim de tijd namen, en zich echt gehoord voelden door deze manier van interviewen. De walk&talk methode is tijdsintensief en werkt alleen als de interviewer zelf bereid is om te vertragen en te luisteren<br><br>            Doordat de gesprekken buiten plaatsvonden,  dienden de gespreksonderwerpen zich als vanzelf aan. Een kapot bushokje leverde meerdere verhalen over de buurt op. Dit maakte ook dat de gesprekken heel natuurlijk verliepen. Wat mij verder opviel, is dat er op deze manier ruimte is voor veel meer persoonlijkere gesprekken. Over hoe mensen in het leven staan en wat - al dan niet in relatie tot de buurt - belangrijk voor hen is. Wellicht komt dit door de nabijheid tot elkaar als je samen wandelt maar er tegelijkertijd meestal geen oogcontact is.                                             ',
            location: {
        ...
        },
        {
            ...
            description: 'Ik heb een analyse van de gevoerde walk&talk gesprekken gemaakt. Hiervoor gebruikte ik de <a href="#mental">mental maps</a> die de deelnemers als samenvatting hadden gemaakt en de door mijzelf geschreven reflecties. Ik ordende de onderwerpen waarover gesproken is. Deze konden in vier categorieën worden ingedeeld: jongeren, gentrificatie, democratie en vergroening. Vervolgens maakte ik een score-indeling om deze onderwerpen in een grafiek te koppelen aan hoelang iemand in het Soesterkwartier woont. <br><br>            Je ziet dat dgenen die het langst in het Soesterkwartier wonen het meest over jongeren en gentrificatie spreken. Zij ondervinden de veranderingen het sterkst. Ook is vergroening voor hen een belangrijk onderwerp. Dat is verklaarbaar, aangezien deze personen in de Bloemenbuurt wonen en hier weinig groen in de omgeving is. Degenen die het kortst in de wijk wonen, wonen in de Rivierenbuurt of de nieuwbouwwijk op de Wagenwerkplaats. Zij richten zich meer op gentrificatie en democratie en verbinding in de buurt.                               ',
            location: {
                center: [5.36276, 52.16034],
                zoom: 15.00,
                pitch: 0.00,
        ...
        },
        {
            ...
            description: ' In mijn ontwerpend onderzoek naar de ontwikkeling van de slow data visualisatie methode zocht ik naar een <em>multilayered storytelling tool</em> in de vorm van een<a href="#conver"> conversation piece</a>. Met het doel om deze in te kunnen zetten voor meerstemmigheid en verdieping van de kennis en daarmee nog meer verbinding in de wijk tot stand te brengen. Om verschillende doelgroepen te kunnen bereiken wilde ik dat de conversation piece laagdrempelig inzetbaar en tastbaar is. Ik heb in mijn iteraties gemerkt dat het geborduurde tafelkleed bovengenoemde doel steeds weer tot stand kan brengen.  <br><br>            Het gaat om het waarderen van aandacht. Het gebruiken van zintuigen en het toepassen van analoge werkvormen. Het gaat om verbinding aangaan met het gebied en de betrokkenen om zo betere inzichten te krijgen in de context. Vertragen helpt om te reflecteren: wat gebeurt er eigenlijk als we stilstaan bij wat we zien. Door de snelheid waarmee we werken zien we vaak veel over het hoofd. Door te vertragen en te observeren ontdekte ik bijvoorbeeld dat de papierbakken bij de ouderenwoningen voor de bewoners een te hoge drempel hebben en zij lastig zelf hun papier kunnen weggooien.  <br><br>             Het laatste onderdeel van mijn slow datavisualisatie methode is verdiepen en het omarmen van de complexiteit met betrekking tot wijkonderzoek. Het gaat er niet om om tot één oplossing te komen, maar juist de meerstemmigheid en de complexiteit van het dagelijkse leven te tonen. Vertragen is vermenigvuldigen <br><br>            De conversation piece kan op verschillende manieren ingezet worden. Bijvoorbeeld om een bepaald thema dat tijdens de<a href="#walktalk"> walk&talk </a> vaak genoemd werd,  verder te verdiepen. Zo kunnen betrokken wijkmakers rondom dit thema uitgenodigd worden om aan de hand van de conversation piece dit onderwerp op een gelijkwaardige manier te bespreken en informatie te delen.             Een andere optie is om de conversation piece in te zetten om eerder opgehaalde informatie juist te koppelen aan nieuwe ontwikkelingen in de wijk. Daarvoor zette ik een community borduurproject <a href=“#sterk”>Sterke Vrouwen</a> op.                      ',
            location: {
                center: [5.36207, 52.15940],
                zoom: 14.00,
                pitch: 13.00,
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'Methode | Achtergrond | Genderongelijkheid en straatnamen',
            image: '',
            imageDescription: '',
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'Methode | Achtergrond | Data feminism',
            image: '',
